                ...
                <label htmlFor="govIdImage" className="cursor-pointer">
                  ...
                  <p className="text-sm text-gray-500 mb-1">
                    {userData.govIdImage ? 
                      ...
                      "ID already uploaded (click to change)" :
                      ...
                      <label htmlFor="speed-test-upload" className="cursor-pointer text-center">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          {userData.speedTest ? 
                            ...
                            "Speed test already uploaded (click to change)" :
                      ...
                      <label htmlFor="system-settings-upload" className="cursor-pointer text-center">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          {userData.systemSettings ? 
                            ...
                            "System settings already uploaded (click to change)" :
                            'Upload a file or drag and drop'
                          }
                        </p>
                        <p className="mt-1 text-xs text-gray-500">
                    ...
                    <div className="flex space-x-4">
                      <label className="inline-flex items-center">
                        <input 
                          ...
                          onChange={() => handleChange('hasHeadset', true)}
                      ...
                      <label className="inline-flex items-center">
                        <input 
                          ...
                          onChange={() => handleChange('hasHeadset', false)}
                          className="w-4 h-4 cursor-pointer text-indigo-600"
                        />
                    ...
                    <div className="flex space-x-4">
                      <label className="inline-flex items-center">
                        <input 
                          ...
                          onChange={() => handleChange('hasQuietPlace', true)}
                          className="w-4 h-4 cursor-pointer text-indigo-600"
                        />
                        <span className="ml-2 text-sm">Yes</span>
                      </label>
                      <label className="inline-flex items-center">
                        <input 
                          ...
                          onChange={() => handleChange('hasQuietPlace', false)}
                          className="w-4 h-4 cursor-pointer text-indigo-600"
                        />
                        <span className="ml-2 text-sm">No</span>
                      </label>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex space-x-3">
                    <button 
                      type="button" 
                      className={`px-4 py-1.5 border rounded text-sm ${userData.meetObligation === true ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-700 border-gray-300'} hover:bg-indigo-600 hover:text-white hover:border-indigo-600`}
                      onClick={() => handleChange('meetObligation', true)}
                    >
                      YES
                    </button>
                    <button 
                      type="button" 
                      className={`px-4 py-1.5 border rounded text-sm ${userData.meetObligation === false ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-700 border-gray-300'} hover:bg-[#00c2cb] hover:text-white hover:border-[#00c2cb]`}
                      onClick={() => handleChange('meetObligation', false)}
                    >
                      NO
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-3">
                    <button 
                      type="button" 
                      className={`px-4 py-1.5 border rounded text-sm ${userData.loginDiscord === true ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-700 border-gray-300'} hover:bg-indigo-600 hover:text-white hover:border-indigo-600`}
                      onClick={() => handleChange('loginDiscord', true)}
                    >
                      YES
                    </button>
                    <button 
                      type="button" 
                      className={`px-4 py-1.5 border rounded text-sm ${userData.loginDiscord === false ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-700 border-gray-300'} hover:bg-[#00c2cb] hover:text-white hover:border-[#00c2cb]`}
                      onClick={() => handleChange('loginDiscord', false)}
                    >
                      NO
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-3">
                    <button 
                      type="button" 
                      className={`px-4 py-1.5 border rounded text-sm ${userData.checkEmails === true ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-700 border-gray-300'} hover:bg-indigo-600 hover:text-white hover:border-indigo-600`}
                      onClick={() => handleChange('checkEmails', true)}
                    >
                      YES
                    </button>
                    <button 
                      type="button" 
                      className={`px-4 py-1.5 border rounded text-sm ${userData.checkEmails === false ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-700 border-gray-300'} hover:bg-[#00c2cb] hover:text-white hover:border-[#00c2cb]`}
                      onClick={() => handleChange('checkEmails', false)}
                    >
                      NO
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-3">
                    <button 
                      type="button" 
                      className={`px-4 py-1.5 border rounded text-sm ${userData.solveProblems === true ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-700 border-gray-300'} hover:bg-indigo-600 hover:text-white hover:border-indigo-600`}
                      onClick={() => handleChange('solveProblems', true)}
                    >
                      YES
                    </button>
                    <button 
                      type="button" 
                      className={`px-4 py-1.5 border rounded text-sm ${userData.solveProblems === false ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-700 border-gray-300'} hover:bg-[#00c2cb] hover:text-white hover:border-[#00c2cb]`}
                      onClick={() => handleChange('solveProblems', false)}
                    >
                      NO
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-3">
                    <button 
                      type="button" 
                      className={`px-4 py-1.5 border rounded text-sm ${userData.completeTraining === true ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-700 border-gray-300'} hover:bg-indigo-600 hover:text-white hover:border-indigo-600`}
                      onClick={() => handleChange('completeTraining', true)}
                    >
                      YES
                    </button>
                    <button 
                      type="button" 
                      className={`px-4 py-1.5 border rounded text-sm ${userData.completeTraining === false ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-700 border-gray-300'} hover:bg-[#00c2cb] hover:text-white hover:border-[#00c2cb]`}
                      onClick={() => handleChange('completeTraining', false)}
                    >
                      NO
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full resize-vertical rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
