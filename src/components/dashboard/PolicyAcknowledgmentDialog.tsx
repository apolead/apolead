...
Individuals can contact Apolead at [Contact Information] to make a complaint, request to be added to the internal Do Not Call list, or ask questions about our telemarketing practices.
Contact Information
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
          ...
          <TabsContent value="telemarketing" className="flex-1 flex flex-col mt-0">
            <ScrollArea className="border rounded-md p-4 h-[400px] bg-slate-50">
              <div className="whitespace-pre-line">{telemarketing_policy}</div>
            </ScrollArea>
          ...
          <TabsContent value="donotcall" className="flex-1 flex flex-col mt-0">
            <ScrollArea className="border rounded-md p-4 h-[400px] bg-slate-50">
              <div className="whitespace-pre-line">{do_not_call_policy}</div>
            </ScrollArea>
