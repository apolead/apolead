...
const Dashboard = () => {
  ...
  const isProbationTrainingCompleted = userProfile?.probation_training_completed === true;
  const isProbationTrainingPassed = userProfile?.probation_training_passed === true;
