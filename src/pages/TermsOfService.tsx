      ...
      <div className="pt-20 pb-16 bg-gray-50">
        <div className="container max-w-4xl mx-auto px-6">
          <div className="mb-6">
            ...
            <h1 className="text-4xl font-bold mb-2 text-gray-800">Terms of Service</h1>
          ...
          <div className="bg-white shadow-md rounded-lg border border-[#4e37b3] p-8">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-800">Agent Eligibility Requirements</h2>
                <p>To be eligible to apply as an ApoLead agent, you must:</p>
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-800">Agent Application Process</h2>
                <p>The agent application process includes:</p>
                <ul className="list-disc pl-6 space-y-0.5">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-800">Intellectual Property Rights</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-800">Changes to the Terms of Service</h2>
                <p>
