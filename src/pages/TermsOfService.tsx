      ...
      <div className="pt-24 pb-16 bg-gray-50">
        <div className="container max-w-4xl mx-auto px-6">
          ...
          <div className="bg-white shadow-md rounded-lg p-8">
            <p className="text-gray-700 mb-5">Last Updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
            
            <section className="mb-5">
              <h2 className="text-2xl font-semibold mb-3 text-gray-800">Agreement to Terms</h2>
              <p className="mb-3">
            ...
            <section className="mb-5">
              <h2 className="text-2xl font-semibold mb-3 text-gray-800">Agent Eligibility Requirements</h2>
              <p className="mb-3">To be eligible to apply as an ApoLead agent, you must:</p>
            ...
            <section className="mb-5">
              <h2 className="text-2xl font-semibold mb-3 text-gray-800">Agent Application Process</h2>
              <p className="mb-3">The agent application process includes:</p>
              <ul className="list-disc pl-6 mb-3 space-y-1 text-gray-700">
            ...
            <section className="mb-5">
              <h2 className="text-2xl font-semibold mb-3 text-gray-800">Intellectual Property Rights</h2>
              <p className="mb-3">
            ...
            <section className="mb-5">
              <h2 className="text-2xl font-semibold mb-3 text-gray-800">Limitation of Liability</h2>
              <p className="mb-3">
            ...
            <section className="mb-5">
              <h2 className="text-2xl font-semibold mb-3 text-gray-800">Governing Law</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-gray-800">Changes to the Terms of Service</h2>
              <p className="mb-3">
