...
const SupervisorDashboard = () => {
  ...
  useEffect(() => {
    const checkUserRole = async () => {
      ...
      if (session) {
        const {
          data: profile
        } = await supabase.from('user_profiles').select('credentials, first_name, last_name').eq('user_id', session.user.id).single();
    ...
    const getUserProfiles = async () => {
      const {
        data,
        error
      } = await supabase.from('user_profiles').select('*').eq('credentials', 'agent').order('application_date', {
        ascending: false
      });
      if (data) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setUserProfiles(prevProfiles => prevProfiles.map(profile => profile.id === selectedProfile.id ? {
        ...profile,
        agent_id: editForm.agent_id,
        supervisor_notes: editForm.supervisor_notes,
        agent_standing: editForm.agent_standing,
  ...
  const filteredProfiles = userProfiles.filter(profile => {
    ...
    return fullName.includes(searchLower) || profile.gov_id_number?.toLowerCase().includes(searchLower) || profile.application_status?.toLowerCase().includes(searchLower);
  });
    ...
    backgroundColor: '#f8fafc'
      ...
      boxSizing: 'border-box'
        ...
        position: sidebarCollapsed ? 'relative' : 'static'
          ...
          <div className="toggle-btn" id="sidebarToggle" onClick={toggleSidebar} style={{
          cursor: 'pointer',
          fontSize: '12px',
          color: '#64748b',
        ...
        justifyContent: sidebarCollapsed ? 'flex-start' : 'flex-start'
          ...
          <a href="#" className="nav-item" onClick={handleLogout} style={{
          display: 'flex',
          alignItems: 'center',
          padding: sidebarCollapsed ? '12px 0' : '12px 20px',
          color: '#64748b',
        ...
        height: sidebarCollapsed ? 0 : 'auto'
          ...
          <i className="fas fa-info-circle"></i> Need help? <a href="#" style={{
          color: '#4f46e5',
          textDecoration: 'none'
        }}>Support Center</a>
        </div>
      ...
      padding: '20px 30px'
        ...
        marginBottom: '25px'
          ...
          alignItems: 'center'
            ...
            transition: 'all 0.3s'
              ...
              <i className="fas fa-chevron-down dropdown-icon" style={{
              marginLeft: '8px',
              color: '#64748b'
            }}></i>
            </div>
        ...
        overflow: 'hidden'
          ...
          marginBottom: '25px'
            ...
            display: 'flex'
              ...
              border: '1px solid #e2e8f0'
                ...
                <input type="text" className="search-input" placeholder="Search by name, ID, or status..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} style={{
                border: 'none',
                background: 'none',
                outline: 'none',
                width: '100%',
          ...
          <Table>
            ...
            <TableBody>
              {filteredProfiles.length > 0 ? filteredProfiles.map(profile => <TableRow key={profile.id}>
                    <TableCell>{`${profile.first_name} ${profile.last_name}`}</TableCell>
                    <TableCell>{profile.gov_id_number || 'N/A'}</TableCell>
                    <TableCell>
                      {profile.gov_id_image ? <button className="btn btn-outline btn-sm" onClick={() => openPhotoModal('id', profile.gov_id_image)}>
                          <i className="fas fa-id-card"></i> View
                        </button> : 'N/A'}
                    </TableCell>
                    <TableCell>
                      {profile.speed_test ? <button className="btn btn-outline btn-sm" onClick={() => openPhotoModal('speed', profile.speed_test)}>
                    ...
                    <TableCell>
                      {profile.sales_skills ? <span className={`badge ${profile.sales_skills === 'Yes' ? 'badge-success' : 'badge-warning'}`}>
                          <i className={`fas ${profile.sales_skills === 'Yes' ? 'fa-check' : 'fa-times'}`}></i>
                          {' '}{profile.sales_skills}
                        </span> : <span className="badge badge-warning">Not set</span>}
                    </TableCell>
                    <TableCell>
                      {profile.communication_rating ? <span className={`badge ${profile.communication_rating === 'Good' ? 'badge-success' : profile.communication_rating === 'Average' ? 'badge-warning' : 'badge-danger'}`}>
                          {profile.communication_rating}
                        </span> : <span className="badge badge-warning">Not set</span>}
                    </TableCell>
                    <TableCell>
                      {profile.application_status && <span className={`status ${getStatusClass(profile.application_status)}`}>
                    ...
                    <TableCell>
                      <button className="action-btn" onClick={() => openEditDialog(profile)} style={{
                  background: 'none',
                  border: 'none',
                  color: '#64748b',
                  cursor: 'pointer',
        ...
        {/* Image Modal */}
        {showImageModal && <div className="modal show" onClick={closeModal} style={{
        display: 'flex',
        position: 'fixed',
        top: 0,
        left: 0,
          ...
          overflowY: 'auto'
            ...
            zIndex: 10
              ...
              alignItems: 'center'
                  ...
                  <i className={`fas fa-${imageType === 'id' ? 'id-card' : 'tachometer-alt'}`} style={{
                marginRight: '10px'
              }}></i>
            ...
            padding: '25px'
              ...
              textAlign: 'center'
                  ...
                  <img src={currentImage} alt={imageType === 'id' ? 'Government ID' : 'Speed Test Result'} style={{
                maxWidth: '100%',
                maxHeight: '70vh',
                border: '1px solid #e2e8f0',
                borderRadius: '8px',
          ...
          <DialogContent className="sm:max-w-[600px]">
            ...
            marginBottom: '20px'
              ...
              <div>
                ...
                <input type="text" value={selectedProfile ? `${selectedProfile.first_name} ${selectedProfile.last_name}` : ''} disabled style={{
                padding: '10px 15px',
                width: '100%',
                border: '1px solid #e2e8f0',
                borderRadius: '10px',
              ...
              <div>
                ...
                <input type="text" name="agent_id" value={editForm.agent_id} onChange={handleInputChange} placeholder="e.g., AG-12345" style={{
                padding: '10px 15px',
                width: '100%',
                border: '1px solid #e2e8f0',
                borderRadius: '10px'
            ...
            marginBottom: '20px'
              ...
              <div>
                ...
                <input type="date" name="start_date" value={editForm.start_date || ''} onChange={handleInputChange} style={{
                padding: '10px 15px',
                width: '100%',
                border: '1px solid #e2e8f0',
                borderRadius: '10px'
              ...
              <div>
                ...
                <input type="text" value={currentUser.first_name + ' ' + currentUser.last_name} disabled style={{
                padding: '10px 15px',
                width: '100%',
                border: '1px solid #e2e8f0',
                borderRadius: '10px',
            ...
            marginBottom: '20px'
              ...
              <select name="application_status" value={editForm.application_status || 'pending'} onChange={handleInputChange} style={{
              padding: '10px 15px',
              width: '100%',
              border: '1px solid #e2e8f0',
              borderRadius: '10px',
            ...
            marginBottom: '20px'
              ...
              gap: '15px'
                ...
                cursor: 'pointer'
                  ...
                  <input type="radio" name="sales_skills" value="Yes" checked={editForm.sales_skills === 'Yes'} onChange={handleInputChange} style={{
                  marginRight: '8px'
                }} />
                  Yes
                </label>
                ...
                cursor: 'pointer'
                  ...
                  <input type="radio" name="sales_skills" value="No" checked={editForm.sales_skills === 'No'} onChange={handleInputChange} style={{
                  marginRight: '8px'
                }} />
                  No
                </label>
            ...
            marginBottom: '20px'
              ...
              <select name="communication_rating" value={editForm.communication_rating || ''} onChange={handleInputChange} style={{
              padding: '10px 15px',
              width: '100%',
              border: '1px solid #e2e8f0',
              borderRadius: '10px',
            ...
            marginBottom: '20px'
              ...
              <input type="email" value={selectedProfile?.email || ''} disabled style={{
              padding: '10px 15px',
              width: '100%',
              border: '1px solid #e2e8f0',
              borderRadius: '10px',
            ...
            marginBottom: '20px'
              ...
              <select name="lead_source" value={editForm.lead_source || ''} onChange={handleInputChange} style={{
              padding: '10px 15px',
              width: '100%',
              border: '1px solid #e2e8f0',
              borderRadius: '10px',
            ...
            marginBottom: '20px'
              ...
              <textarea name="supervisor_notes" value={editForm.supervisor_notes || ''} onChange={handleInputChange} placeholder="Enter notes about this agent..." style={{
              padding: '10px 15px',
              width: '100%',
              border: '1px solid #e2e8f0',
              borderRadius: '10px',
            ...
            <DialogFooter>
              ...
              <Button onClick={handleSubmit} className="text-neutral-50">
