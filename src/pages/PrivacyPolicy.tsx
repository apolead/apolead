      ...
      <div className="pt-24 pb-16 bg-gray-50">
        <div className="container max-w-4xl mx-auto px-6">
          ...
          <div className="bg-white shadow-md rounded-lg p-8">
            <p className="text-gray-700 mb-6">Last Updated: {currentDate}</p>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-700">We take data security seriously and use the following safeguards:</p>
              <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-700">Apolead complies with the following regulations:</p>
              <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
